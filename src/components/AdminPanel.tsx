        ...
        <div className="flex gap-2 mb-6">
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium text-sm flex items-center gap-2 ${
              tab === 'quotes' ? 'bg-[var(--accent)] text-white' : 'bg-[var(--surface)] text-[var(--text-secondary)]'
            }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium text-sm flex items-center gap-2 ${
              tab === 'products' ? 'bg-[var(--accent)] text-white' : 'bg-[var(--surface)] text-[var(--text-secondary)]'
            }`}
          >
              ...
              quotes.map((q) => (
                <div key={q.id} className="card p-5">
                  ...
                  {q.snapshot.specialRequests && (
                    <p className="text-sm text-[var(--text-muted)] mt-2 italic">"{q.snapshot.specialRequests}"</p>
                  )}
                </div>
              ))
            )}
